...
defbindings("WScreen", {
    ...
    kpress("Mod4+E",  "ioncore.exec_on(_, 'xemacs')"),
    kpress("XF86WWW", "ioncore.exec_on(_, 'firefox')"),
    submap("Mod1+P", {
      kpress("L", "ioncore.exec_on(_, 'xscreensaver-command -lock')"),
    }),
    --kpress(ALT..CONTROL.."S",  "ioncore.exec_on(_, 'xwd -root | convert - /tmp/screenshot.png')"),
})
